...
public class AutoConfig {
    ...
    public static <T extends ConfigData> ConfigScreenProvider<T> getConfigScreenProvider(Class<T> configClass, Screen parent) {
    ...
    public static <T extends ConfigData> Supplier<Screen> getConfigScreen(Class<T> configClass, Screen parent) {
        return getConfigScreenProvider(configClass, parent);
    }
