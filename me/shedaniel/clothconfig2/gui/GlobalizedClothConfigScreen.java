...
import ovo.xsvf.izmk.misc.util.MethodHelper;
...
public class GlobalizedClothConfigScreen extends AbstractConfigScreen implements ReferenceBuildingConfigScreen, Expandable {
    ...
    public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
        ...
        Rectangle slideArrowBounds = new Rectangle(sliderPosition - 14, 0, 14, height);
        {
            ...
            MethodHelper.getInstance()
                    .addParam(15728880)
                    .addParam(0)
                    .addParam(false)
                    .addParam(immediate)
                    .addParam(matrices.last().pose())
                    .addParam(false)
                    .addParam((slideArrowBounds.contains(mouseX, mouseY) ? 16777120 : 16777215) | Mth.clamp(Mth.ceil((1 - sideSlider.scrollAmount()) * 255.0F), 0, 255) << 24)
                    .addParam(height / 2)
                    .addParam(sliderPosition - 7 - font.width(">") / 2f)
                    .addParam(">")
                    .callMcp(font, "net/minecraft/client/gui/Font", "renderText", "(Ljava/lang/String;FFIZLcom/mojang/math/Matrix4f;Lnet/minecraft/client/renderer/MultiBufferSource;ZII)F");
            MethodHelper.getInstance()
                    .addParam(15728880)
                    .addParam(0)
                    .addParam(false)
                    ...
                    .addParam(matrices.last().pose())
                    .addParam(false)
                    .addParam((slideArrowBounds.contains(mouseX, mouseY) ? 16777120 : 16777215) | Mth.clamp(Mth.ceil(sideSlider.scrollAmount() * 255.0F), 0, 255) << 24)
                    .addParam(height / 2)
                    .addParam(sliderPosition - 7 - font.width("<") / 2f)
                    .addParam("<")
                    .callMcp(font, "net/minecraft/client/gui/Font", "renderText", "(Ljava/lang/String;FFIZLcom/mojang/math/Matrix4f;Lnet/minecraft/client/renderer/MultiBufferSource;ZII)F");
